...
void FNTGetPath(unsigned char path, unsigned char *destination, int length) {
	int i;
	int offset = 0;
...
void FNTGetchar (char chr, unsigned char *dst) {
    uint8 i;
...
void FNTGetbitmap (char bitmap, unsigned char *dst) {
	int i;
...
unsigned char FNTGetBitmapPixel (char bitmap, char x, char y) {
