...
/*
 * transistor switch delay count. Needed to reduce flicker in primary
 * interrupt at higher clock speeds due to transistor switching time
 *
 */
#define Q_DELAY         25
...
#define INT_T2_TEST_PIN 0x40        // Used for calibrating T2 interrupt speed
#define INT_T4_TEST_PIN 0x80        // Used for calibrating T4 interrupt speed
...
#define LCD_BTN_STBY_ON             0x071E01000119
#define LCD_BTN_STBY_OFF            0x071E01000018
...
#define LCD_ANIM_SKIP_CHG           0x07060A00000B
